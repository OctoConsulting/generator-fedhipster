...
const expectedFiles = {
    ...
    client: [
        ...
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jhi-jvm-memory.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jhi-jvm-threads.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jhi-metrics-cache.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jhi-metrics-datasource.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jhi-metrics-endpoints-requests.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jhi-metrics-garbagecollector.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jhi-metrics-modal-threads.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jhi-metrics-request.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/admin/metrics/jhi-metrics-system.component.ts`,
        ...
        `${CLIENT_MAIN_SRC_DIR}app/layouts/header/header.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/layouts/header/header.scss`,
        `${CLIENT_MAIN_SRC_DIR}app/layouts/banner/banner.component.html`,
        `${CLIENT_MAIN_SRC_DIR}app/layouts/banner/banner.component.ts`,
        `${CLIENT_MAIN_SRC_DIR}app/layouts/banner/banner.scss`,
        ...
        `${CLIENT_MAIN_SRC_DIR}content/css/loading-uswds.css`,
        ...
        `${CLIENT_MAIN_SRC_DIR}content/images/us_flag_small.png`,
